                            ...
                            <div class="account-layout">
                                <aside class="account-sidebar">
                                    ...
                                    <ul class="account-nav-list">
                                        <li class="active"><a href="#personal-info" data-tab="info"><ion-icon
                                                    name="person-circle-outline"></ion-icon> Thông tin cá nhân</a></li>
                                        <li><a href="#change-password" data-tab="password"><ion-icon
                                                    name="lock-closed-outline"></ion-icon> Đổi mật khẩu</a></li>
                                        <li><a href="#address-book" data-tab="address"><ion-icon
                                                    name="map-outline"></ion-icon> Sổ
                                                địa chỉ</a></li>
                                ...
                                <div class="account-content">
                                    <% String msg=(String) request.getAttribute("msg"); String msgType=(String)
                                        request.getAttribute("msgType"); if (msg !=null) { String alertClass=(msgType
                                        !=null && msgType.equals("success")) ? "alert-success" : "alert-danger" ; %>
                        ...
                        <div class="modal" id="logoutModal" style="display: none;">
                            <div class="modal-content">
                                ...
                                <div class="modal-actions">
                                    ...
                                    <a href="${pageContext.request.contextPath}/logout" class="btn-confirm-logout">Có,
                                        đăng
                                        xuất</a>
                                </div>
                            </div>
